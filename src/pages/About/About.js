...
<stop offset="0.984375" stop-color="#B3B1FF"/>
 ...
 {/*  <div className='clouds'>
  <motion.svg width="167" height="89" viewBox="0 0 167 89" fill="none" xmlns="http://www.w3.org/2000/svg"
animate={{x: [-300, 1300]}}
transition={{duration: 30, ease: "linear",
times: [0, 0.2, 0.5, 0.8, 1],
repeat: Infinity,
repeatDelay: 1}}>
<path d="M139.176 71.5291C153.514 72.1786 165.639 61.6351 166.258 47.9796C166.666 38.9763 161.97 30.8681 154.614 26.2022C154.41 23.9849 153.931 21.7359 153.157 19.509C148.667 6.60274 135.929 -0.677186 124.706 3.24879C123.372 3.71546 122.119 4.31946 120.955 5.04322C116.791 1.27515 110.811 -0.168272 105.204 1.79302C99.6991 3.71867 95.9482 8.43871 94.9397 13.8604C88.998 8.12081 80.8075 5.72836 73.2954 8.35612C69.4491 9.70158 66.2798 12.1886 63.9559 15.3961C57.9735 9.22364 49.4776 6.57067 41.7075 9.28868C34.8729 11.6794 30.1761 17.6744 28.5617 24.9118C26.4236 24.1732 24.1072 23.719 21.6775 23.6089C10.2069 23.0893 0.556225 30.4365 0.122145 40.0194C-0.274136 48.7678 7.14793 56.355 17.171 58.0054C16.7582 59.5875 16.5046 61.2329 16.4279 62.9262C15.8093 76.5817 26.9313 88.1783 41.2696 88.8278C51.1962 89.2774 60.062 84.3623 64.7832 76.7638C68.5984 79.2001 73.1345 80.7084 78.0484 80.931C85.1383 81.2522 91.687 78.8366 96.5711 74.6613C100.24 76.5925 104.453 77.7803 108.966 77.9848C117.542 78.3732 125.356 75.1279 130.607 69.7385C133.267 70.7673 136.15 71.392 139.176 71.5291Z" fill="url(#paint0_linear_19_42)"/>
<defs>
<linearGradient id="paint0_linear_19_42" x1="83.1947" y1="0.917908" x2="83.1947" y2="88.8562" gradientUnits="userSpaceOnUse">
<stop offset="0.0549306" stop-color="#F8F8F8"/>
<stop offset="1" stop-color="#DCEBFD" stop-opacity="0.88"/>
</linearGradient>
</defs>
</motion.svg>

<motion.svg width="84" height="44" viewBox="0 0 84 44" fill="none" xmlns="http://www.w3.org/2000/svg"
animate={{x: [-300, 1300]}}
transition={{duration: 25, ease: "easeOut",
times: [0, 0.2, 0.5, 0.8, 1],
repeat: Infinity,
repeatDelay: 0.2}}>
<path d="M51.6102 12.0601C49.3387 7.99479 45.1018 5.26086 40.25 5.26086C37.7658 5.26086 35.4428 5.9776 33.4623 7.22282C31.254 2.92495 26.8934 0 21.875 0C14.6263 0 8.75002 6.10255 8.75002 13.6304C8.75002 14.5639 8.84037 15.4754 9.01249 16.3561C3.91796 17.0143 0 21.0034 0 25.8261C0 31.1088 4.70101 35.3913 10.5 35.3913C11.5621 35.3913 12.5874 35.2477 13.5537 34.9805C18.2155 40.2984 28.6112 44 40.6875 44C50.603 44 59.3855 41.5046 64.7914 37.6679C66.6099 38.6576 68.6795 39.2174 70.875 39.2174C78.1237 39.2174 84 33.1149 84 25.587C84 18.0591 78.1237 11.9565 70.875 11.9565C70.0134 11.9565 69.1711 12.0428 68.3558 12.2074C66.7129 9.49053 63.5587 7.65219 59.9375 7.65219C56.3821 7.65219 53.2769 9.42433 51.6102 12.0601Z" fill="url(#paint0_linear_19_43)"/>
<defs>
<linearGradient id="paint0_linear_19_43" x1="106.5" y1="31" x2="-4.5" y2="22" gradientUnits="userSpaceOnUse">
...
<motion.svg width="181" height="59" viewBox="0 0 181 59" fill="none" xmlns="http://www.w3.org/2000/svg"
animate={{x: [-300, 1300]}}
transition={{duration: 40, ease: "easeIn",
times: [0, 0.2, 0.5, 0.8, 1],
repeat: Infinity,
repeatDelay: 0.7}}>
<path d="M111.208 16.1716C106.313 10.7203 97.1836 7.05438 86.7292 7.05438C81.3763 7.05438 76.3708 8.01546 72.1032 9.68517C67.3449 3.9221 57.9489 0 47.1354 0C31.5161 0 18.8542 8.18297 18.8542 18.2772C18.8542 19.5289 19.0489 20.7511 19.4197 21.9321C8.44225 22.8146 0 28.1636 0 34.6305C0 41.7141 10.1296 47.4566 22.625 47.4566C24.9136 47.4566 27.1228 47.2639 29.205 46.9057C39.25 54.0366 61.6503 59 87.6719 59C109.037 59 127.962 55.6539 139.61 50.5093C143.529 51.8363 147.988 52.587 152.719 52.587C168.338 52.587 181 44.404 181 34.3098C181 24.2156 168.338 16.0327 152.719 16.0327C150.862 16.0327 149.047 16.1483 147.291 16.369C143.75 12.7259 136.954 10.2609 129.151 10.2609C121.49 10.2609 114.799 12.6372 111.208 16.1716Z" fill="url(#paint0_linear_19_44)"/>
<defs>
<linearGradient id="paint0_linear_19_44" x1="59.5" y1="-6.99998" x2="230" y2="87.5" gradientUnits="userSpaceOnUse">
<stop offset="0.0428965" stop-color="#DDEFFA" stop-opacity="0.4"/>
<stop offset="0.750057" stop-color="#F7F8FB" stop-opacity="0.97"/>
</linearGradient>
</defs>
</motion.svg>

<motion.svg width="219" height="71" viewBox="0 0 219 71" fill="none" xmlns="http://www.w3.org/2000/svg"
animate={{x: [-300, 1300]}}
transition={{duration: 35, ease: "easeIn",
times: [0, 0.2, 0.5, 0.8, 1],
repeat: Infinity,
repeatDelay: 0.5}}>
<path d="M68 0C53.5921 0 41.5565 9.64893 38.6624 22.5159C35.2097 20.9131 31.2328 20 27 20C13.7452 20 3 28.9543 3 40C3 41.3893 3.16998 42.7455 3.49359 44.055C1.21368 45.794 0 47.6188 0 49.5C0 61.3741 48.3533 71 108 71C164.408 71 210.716 62.3911 215.578 51.4131C217.745 48.5477 219 45.1472 219 41.5C219 31.2827 209.15 23 197 23C193.315 23 189.841 23.762 186.79 25.1088C185.025 10.9672 172.361 0 157 0C145.757 0 135.958 5.87567 130.821 14.5711C125.838 11.0701 119.673 9 113 9C106.008 9 99.5748 11.2723 94.4738 15.0821C89.4227 6.10669 79.4621 0 68 0Z" fill="url(#paint0_linear_19_41)"/>
<defs>
<linearGradient id="paint0_linear_19_41" x1="109.5" y1="0" x2="109.5" y2="71" gradientUnits="userSpaceOnUse">
<stop offset="0.307292" stop-color="#F8F8F8" stop-opacity="0.92"/>
<stop offset="0.96875" stop-color="#DCEBFA" stop-opacity="0.38"/>
</linearGradient>
</defs>
</motion.svg>
